--create_account.php
	...
	--get all names and birthdates from customers table to populate current profiles table
...
--add_cuisine.php
	...
	--display all current cuisine types from cuisine table in a table
...
--update_cuisine.php
	...
	--get all customer names and cuisine preferences from cuisine and customer tables to populate table
...
--add_restaurant.php
	...
	--display all current restaurants with location and cuisine from restaurant,location, and cuisine table in a table
...
--remove_review.php
	...
	--display all current reviews by a customer fromreviews_restaurants_customers table in a table 
...
--view.php
	...
	--get count of likes and dislikes from reviews_restaurants_customers table to display in table
		SELECT COUNT(review)
        FROM `reviews_restaurants_customers`
